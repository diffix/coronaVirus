...
The map shows a combination of information. It's main feature is a heatmap of taxi trips. With the different sliders
...
fades out and the rectangles of data records become visible. Each record shows its number of taxi trips. These
